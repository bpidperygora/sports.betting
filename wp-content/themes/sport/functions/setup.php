...
if ( ! function_exists( 'avatar_attributes' ) ) {
	function avatar_attributes($avatar_attributes) {
...
add_filter('get_avatar','avatar_attributes');

if ( ! function_exists( 'author_avatar' ) ) {
...
if ( ! function_exists( 'author_description' ) ) {
